...
public class VetorCrescente {
	public static void main(String[] args) {
		System.out.println(
				"Bem vindo ao programa de exercício de vetor! \n Iremos exercitar a ordenação do vetor em ordem crescente referente a notas em uma turma de alunos!");
		...
		System.out.println("A listagem foi concluída! Agora iremos organizar as notas em ordem crescente...");
		Arrays.sort(notas);
		for (int a = 0; a < notas.length; a++) {
			System.out.println("Aluno " + (a + 1) + ", nota:  " + notas[a]);
		}
